  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "flex-end" }}>
        ...
        >
          <IconButton
            disabled={uploadedFiles.length >= MAX_FILES || isThinking || isDisabled}
            color="primary"
            onClick={() => fileInputRef.current?.click()}
            sx={{ mr: 1 }}
          >
            <Badge badgeContent={uploadedFiles.length || null} color="primary">
              <AttachFileIcon color={(isThinking || isDisabled) ? "disabled" : "primary"} />
            </Badge>
          </IconButton>
        </Tooltip>
        ...
        <TextField
          ...
          InputProps={{
            endAdornment: (
              <IconButton
                color="primary"
                disabled={inputText.trim() === "" || isThinking || isDisabled}
                onClick={handleSendMessage}
                sx={{                  animation: (isThinking || isDisabled)
