...
export { default as ResourceContentTab } from './ResourceContentTab';
export { default as FilesTab } from './FilesTab';
export { default as KnowledgeGraphTab } from './KnowledgeGraphTab';
export { default as KnowledgeMainContent } from './KnowledgeMainContent';
...
export { default as KnowledgeExplorerLayout } from './KnowledgeExplorerLayout';
...
export { default as KnowledgeResourceManager } from './KnowledgeResourceManager';
